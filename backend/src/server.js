...
app.use('/api/stock-import', require('./modules/stock/import.routes'));
app.use('/api/stock-releve', require('./modules/stock/daily-readings.routes'));
...
app.use('/api/checklists', require('./modules/logistique/checklists.routes'));
app.use('/api/vehicle-documents', require('./modules/logistique/vehicle-documents.routes'));
...
app.use('/api/dsi/projects', require('./modules/dsi/dsi.projects.routes'));
app.use('/api/dsi/risks', require('./modules/dsi/dsi.risks.routes'));
