...
export default function MouvementForm() {
  ...
  const buProducts = useMemo(
    () => products.filter(p => !form.business_unit_id || String(p.business_unit_id) === String(form.business_unit_id)),
  ...
  return (
    <div>
      <StockSectionNav />
      <h1 className="page-title" style={{ margin: '0 0 4px' }}>Saisie mouvement</h1>
      <p className="page-subtitle" style={{ margin: '0 0 12px' }}>Enregistrez une entrée ou une sortie. La quantité est toujours positive — le type de mouvement en détermine le sens.</p>
